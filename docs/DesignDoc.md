![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.001.jpeg)

**Design Document**

09/16/2024

*ShelbyJoyner GavinFortwendel Cass Mitchell ClaytonWhitten*
...
- Non-FunctionalRequirements 5
- **Design Outline 8**
- High-LevelOverview 8
- DesignDecisions andComponent Identification 8
- Interactions BetweenComponents 9
- State/ActivityDiagram 10
- **Design Issues 11**
- FunctionalIssues 11
- Non-FunctionalIssues 13
- **Design Details 15**
- Class Design 15
...
1. I would like to see other users’sprites in a concurrent room.
1. I would like to be able to choose to create a room or join a room via a menu.
1. I would like to see other user’s display names.
1. I would like to be able to give another user a thumbs up for good work.
2. Room: As a user,
5. I would like to join a room with a join code.
5. I would like to create a room.
5. I would like to be able to reopen a room I previously created.
5. I would like to leave the room I am in.
3. Login/sign-up:

   As a user logging in,

9. I would like to be able to create an account if I do not already have one.
9. I would like to be able to log in to my account with an email and password.
9. I would like to be able to log in using Google, Apple, or Microsoft.
9. I would like to be able to reset my password if I forget it.
4. Settings Menu:

   As a user interacting with settings,

13. I would like to open a menu for settings options.
13. I would like to change my microphone input device.
13. I would like to change my camera input device.
13. I would like to change the volume.
13. I would like to change my display name.
5. File sharing:

   As a user wanting to interact with the file system,

18. I would like to interact with a 2D file cabinet object that opens a file sharing menu.
18. I would like to upload files from my device for anyone to view.
18. I would like to export files to my device.
18. I would like to view unrestricted files uploaded by other users.
18. I would like to get currency if someone downloads a file I uploaded.
18. I would like to have files I upload remain uploaded, even after I leave.
6. Whiteboard:

   As a user interacting with the whiteboard system,

24. I would like to interact with a 2D whiteboard object that opens a whiteboard frame.
24. I would like to draw on the whiteboard.
24. I would like to erase my work from the whiteboard.
24. I would like to see other users’drawings on the whiteboard in real time.
24. I would like to use different colors on the whiteboard.
24. I would like to be able to lock the whiteboard so only I can draw on it.
24. I would like to draw on the whiteboard concurrently with other users.
7. Shop/Customization:

   As a user interacting with the shop system,

31. I would like to purchase a cosmetic of my choice from the shop using currency.
31. I would like to gain currency when giving another user a thumbs up.
31. I would like to receive currency when someone else interacts with my files.
31. I would like to view the shop window and browse items.
31. I would like to view the amount of currency I have.
8. User inventory:

   As a user interacting with the inventory system,

36. I would like to click a button that opens an inventory menu.
36. I would like to see all the cosmetics I have purchased for my sprite.
36. I would like to see all the decorations I have purchased for the room.
36. I would like to apply cosmetics to my sprite.
36. As a user who created the room, I would like to apply decorations to the room.
9. Audio communication:

   As a user interacting with the audio communication system,

41. I would like to talk to other users in a concurrent room.
41. I would like to mute my microphone on the game screen.
10. Video Communication (If time allows):

    As a user interacting with the video communication system,

43. I would like to have a choice to join a video call with other users.
43. I would like to be able to turn off my camera on the game screen.

Non-FunctionalRequirements

1. Architecture: As a developer,
1. I want to use the game engine Unity to create our game.
1. I want to use C# to code scripts that will affect game objects in Unity and
...
3. I want to use the free tier of Photon Cloud to host servers online.
2. Performance: As a user,
5. I want Class-fy to run smoothly and have real-time interactions between players on the same server.
5. I want to quickly upload and download files from the in-game “file cabinet”.

As a developer,

7. I want to use Firebase for storing file contents as it can support fast file uploads and downloads, and will resume connection to the database during these operations if it dissipates.
7. I want to use Firebase to store user account data, files, and other game data as the free plan can store up to 1GB.
7. I want to use Firebase and allow for 100 simultaneous connections to the real-time database.
3. Scalability:

   As a developer,

10. I want the code base to be clean and well-organized so it is easy to add additional features and make bug fixes without breaking existing features.
10. I want to optimize our code so the performance of the game is as good as possible.
10. I want to use Firebase to store large amounts of user data since it is a flexible and easily scalable database tool.
4. Usability: As a user,
13. I want Class-ify to be user friendly and easy to navigate, meaning its UI has a clean design that flows smoothly.
13. I want the default controls for the game to be intuitive, meaning they should follow the industry standards (WASD for movement, etc).
15. I want the game to be as accessible as possible; therefore the system requirements to run the game should be limited.
5. Security:

   As a developer,

16. I want to use Firebase’s authentication system to store user credentials and verify their login information.
16. I want to allow users to sign in users an email/password.
16. I want to allow users to sign in using Google, Microsoft, or Apple as an alternative.
6. Hosting/Deployment: As a developer,
19. I want to create a build for WebGL in Unity once our game is complete so we can host it on a website.
19. I want to use Photon Cloud to host the game’s servers (classrooms) and have a maximum of 16 players on one server at a time.
19. I want Photon to allow users to join servers (classrooms) made by other users using a join code.
...
![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.002.png)

DesignDecisions andComponent Identification

1. Client
   1. The client provides the user with an interface to navigate the virtual classroom and interact with other users.
   1. The client sends requests to the Photon Cloud to join or create a room.
   1. The client sends requests to Firebase for user authentication and profile retrieval.
   1. The client communicates user inputs, such as movements or actions, to the Photon Cloud.
1. Photon Cloud
1. The Photon Cloud manages the connection between the clients, ensuring real-time communication.
1. The Photon Cloud relays inputs and actions between the clients,

   synchronizing the room state for all users.
...
1. The Firebase Database handles authentication requests by validating login credentials and managing user profiles.
...
![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.003.png)
...
1. Option 2: Users can log in using a username and password
1. Option 3: Users can log in using Google, Microsoft, or Apple
1. Option 4: Users will not be required to log in
...
2. How will users create an account for our game?
1. Option 1: Email and password
1. Option 2: Email, username and password
1. Option 3: Username and Google, Microsoft, or Apple
...
3. What happens when the host of a room leaves?
1. Option 1: The room closes and all players in the room are kicked
1. Option 2: Another player in the room becomes the host
1. Option 3: A server becomes the host of the room rather than an individual
...
4. What options will users have for interaction?
1. Option 1: Voice and video chat
1. Option 2: File sharing and messaging
1. Option 3: Live writing/drawing in a shared space
...
5. When should whiteboard drawings from users disappear?
1. Option 1: A user’s drawings disappear when they disengage with the whiteboard
1. Option 2: A user’s drawings disappear when they disconnect from the room.
1. Option 3: A user’s drawings never disappear (even when the server is not running) until they are erased or the “clear whiteboard” button is pressed.
...
2. Which engine is best suited for designing our game?
1. Option 1: Unity
1. Option 2: Unreal Engine
...
3. Will servers be hosted on the room creator’s computer or will they be hosted online?
1. Option 1: Server is hosted completely online
1. Option 2: Server is hosted from the room creator’s computer

Choice: Option 1

Justification: We decided to have the servers (classrooms) hosted online using Photon Cloud, as this would ensure that when the host of a room (user who created it) leaves, other users will not be kicked out of the room. Hosting it online is also a simpler

solution, as some technical details are abstracted away by Photon Cloud.

4. What system should be used for hosting rooms and implementing multiplayer in our game?
1. Option 1: Photon Cloud
1. Option 2: Unity Netcode
1. Option 3: Photon Server
...
![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.004.jpeg)
...
- The Shop class stores all the cosmetics that the user can purchase for their sprite
...
![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.005.jpeg)

![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.006.jpeg)

![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.007.jpeg)

![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.008.jpeg)

![](Aspose.Words.25831801-5c03-42c7-94a4-65588f46271b.009.jpeg)
22
